...
public class Algoritmos {	
	...
	/**
	 * Método 2 para sumar enteros desde 1 hasta n
	 * utilizando un método recursivo de cola
	 * @param n Límite de la suma
	 * @return Resultado de sumar los enteros desde el 1 hasta n
	 */
	...
	/**
	 * Inicializa el método recursivo que imprime en pantalla el contenido de un arreglo unidimensional
