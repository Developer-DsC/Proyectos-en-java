...
/**
 * Clase con los métodos necesarios para leer objetos tipo <T> de un archivo
 * @author Fausto Redrovan
 * @version 15/06/2023
 *
 * @param <T> Clase genérica para el tipo de los objetos que son recuperados del archivo
 */
