 ...
 * @author Dalton
 */
public class Banco_sucursales extends javax.swing.JFrame {

    /**
     * Creates new form Banco_sucursales
     */
    public Banco_sucursales() {
    ...
    int n, i = 1, numero = 0, litA = 0, tc = 0, tq = 0, tg = 0, canDepPasaje = 0, canDepMachala = 0, canDepCuenca = 0;
    ...
    private void btn_ingresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ingresarActionPerformed
        if (i <= n) {
            ...
            if (i == n) {
                ...
                cmb_transaccion.setEnabled(false);
            }
            i = i + 1;
        }
    ...
    public void Imprimir() {
        ...
        //Literal a
        JOptionPane.showMessageDialog(null, "Cantidad de depositos por mas de $1000: " + litA);
        //Literal b
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Banco_sucursales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Banco_sucursales().setVisible(true);
        });
    }
